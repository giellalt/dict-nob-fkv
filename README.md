# Dictionary for nob — fkv

This repository contains source files for a dictionary from Norwegian Bokmål to Kven. The content is licensed under the CC-BY-4.0 license.
